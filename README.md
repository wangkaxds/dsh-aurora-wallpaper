...
别人家的 AI 界面是灰底白字；你的界面背景是**心爱的角色在你聊天框后面呼吸，发丝随风水波荡漾**。这不是视频回放——这是壁纸引擎的场景文件被**真·重新渲染**：每一层图层、每一条效果链、每一个 HLSL 着色器，都被实时翻译成 GLSL 在你的 GPU 上跑。
...
| ⚡ 性能档位 | 均衡 60fps / 省电 30fps / 低配 30fps+效果降采样，窗口失焦自动暂停渲染，选完即生效 |
